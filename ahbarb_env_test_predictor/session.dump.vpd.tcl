...
gui_sg_addsignal -group "$_session_group_1" { tb_top.dut.state tb_top.dut.clk_i tb_top.dut.rst_ni tb_top.dut.te_haddr_s_i tb_top.dut.te_htrans_s_i tb_top.dut.te_hready_s_i tb_top.dut.te_hwrite_s_i tb_top.dut.te_hwdata_s_i }
...
gui_open_source -id ${Source.1}  -replace -active tb_top.dut trc_ahbarb.sv
gui_src_value_annotate -id ${Source.1} -switch true
gui_set_env TOGGLE::VALUEANNOTATE 1
gui_view_scroll -id ${Source.1} -vertical -set 1416
